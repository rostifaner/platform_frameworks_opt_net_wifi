...
public class WifiServiceImpl extends IWifiManager.Stub {
    ...
    public synchronized boolean setWifiEnabled(String packageName, boolean enable)
        ...
        if(isStrictOpEnable()){
            ...
            if((Binder.getCallingUid() > 10000) && (aPackageName.indexOf("android.uid.systemui") !=0)  && (aPackageName.indexOf("android.uid.system") != 0)) {
                AppOpsManager mAppOpsManager  = mContext.getSystemService(AppOpsManager.class);
                int result = mAppOpsManager.noteOp(AppOpsManager.OP_CHANGE_WIFI_STATE,Binder.getCallingUid(),aPackageName);
